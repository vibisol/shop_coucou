...
export default Footer;
            ...
            {/* <Box className='footer_contact'>
                <Link href='https://t.me/your_telegram_username' target='_blank'>
                    <img src='/img/wp.png' alt='Telegram' style={{ width: 'auto', height: 'auto' }} />
                </Link>
                <Link href='https://wa.me/your_whatsapp_number' target='_blank'>
                    <img src='/img/tg.png' alt='WhatsApp' style={{ width: 'auto', height: 'auto' }} />
                </Link>
                <Link href='https://wa.me/your_whatsapp_number' target='_blank'>
                    <img src='/img/inst.png' alt='WhatsApp' style={{ width: 'auto', height: 'auto' }} />
                </Link>
            </Box> */}
