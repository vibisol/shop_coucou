        ...
        <Box className='refund_name' > ОБМЕН И ВОЗВРАТ</Box>
            ...
            <Box className='refund_info'>
                ...
                <Box className='refund_info_5'> 
                    ...
                    <Box className='refund_info_5_text'>
                    <p>Гарантия на изделия действует в течение 30 календарных дней.</p> 
                    <p>Гарантийными случаями не являются:</p>
                    <p>- окрас подклада, стельки изделий.</p>
                    <p>- кладки и морщины, образованные естественным путём в процессе эксплуатации.</p>
                    <p>- естественная деформация материалов с учетом их особенностей.</p>
                    <p>- стирание и отслаивание слоев подошвы до 3 мм.</p>
                    <p>- механическая деформация фурнитуры (молнии, пряжки и т.д.).</p>
                    <p>- обращения по изделиям, прошедшим ремонтные работы сторонними службами.</p>
                    <p>- обращения по изделиям с эксплуатацией во внесезонный период.</p>
                    <p>- омеханические повреждения, появившиеся по вине покупателя (ожоги, порезы и др.), а также деформации в результате неправильной носки, сушки, мойки, химического воздействия.</p>
                    </Box>
                </Box>
            </Box>
    </Box>
