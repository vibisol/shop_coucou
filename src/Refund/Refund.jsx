        ...
        <Box className='refund_name' > ОБМЕН И ВОЗВРАТ</Box>
            ...
            <Box className='refund_info'>
                ...
                <Box className='refund_info_4'> 
                    ...
                    <p>- свяжитесь с менеджером в <a className='link' style={{color: 'inherit'}}  href="https://t.me/CouCou_spb" >Telegram</a> или <a className='link' style={{color: 'inherit'}} href="https://wa.me/79112869339">WhatsApp</a> (кликабельная ссылка).</p>
